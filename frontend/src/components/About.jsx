          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 pt-8">
            {about.highlights.map((highlight, index) => {
              ...
              return (
                <Card
                  key={index}
                  className="bg-gray-900/50 border-gray-800 hover:border-accent-jetbrains/50 hover:shadow-lg hover:shadow-accent-jetbrains/10 transition-all duration-300 hover:scale-105 p-6"
                >
                  <div className="flex flex-col items-center text-center space-y-3">
                    <div className="p-3 bg-gradient-to-br from-accent-jetbrains/10 to-accent-pink/10 rounded-lg">
                      <Icon className="text-accent-jetbrains" size={32} />
                    </div>
