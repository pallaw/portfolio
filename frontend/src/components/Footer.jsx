            ...
            {socialLinks.map((social, index) => {
              ...
              return (
                <a
                  ...
                  className="p-3 bg-gray-900/50 rounded-lg border border-gray-800 hover:border-accent-compose-royal/50 hover:bg-accent-compose-royal/10 transition-all duration-300 hover:scale-110"
